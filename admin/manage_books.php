...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action']=='add') {
    $name = $_POST['bookname']; $author = $_POST['author']; $cat = $_POST['category']; $desc = $_POST['description'];
    ...
    <form method="post" enctype="multipart/form-data" class="add-book-form">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 10px;">
          <div style="flex: 1 1 30%;">
              <label>Title</label><input name="bookname" required>
          </div>
          <div style="flex: 1 1 30%;">
          ...
          <div style="flex: 1 1 15%;">
              <label>Quantity</label><input name="quantity" type="number" value="1" min="1" required>
          </div>
          <div style="flex: 1 1 40%;">
              <label>Cover image</label><input type="file" name="image">
          </div>
