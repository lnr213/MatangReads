...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if (in_array($action, ['approved','rejected'])) {
        ...
        $pdo->prepare("UPDATE book_requests SET status = ? WHERE req_id = ?")->execute([$action, $id]);
        
        // OPTIONAL: If approved, you would normally send a notification to the user
        // and add the book to the main catalog (not automated here).
    }
...
?>
<!doctype html>
<html><head><meta charset="utf-8"><title>Manage Book Requests</title>
